...
20. **Cell 20: Stage 1 后 serious eval + template ablation refresh**
...
- **更利于数据增益**：external/synthetic mixture 与 consensus pseudolabel refresh 已经接入主训练路径。
